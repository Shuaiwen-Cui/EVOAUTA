...
@REM git push -f https://github.com/Shuaiwen-Cui/EVOAUTA.git main
git push -f https://github.com/Shuaiwen-Cui/EVOAUTA.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/EVOAUTA.git
